...
# Dead-dependency audit (unused declared / used undeclared / non-test-scoped).
# Run after `just verify` so classes are already compiled for accurate results.
analyze:
    mvn -B dependency:analyze -DfailOnWarning=true

# Regenerate protobuf stubs: `just generate-sources`
generate-sources:
    mvn -B -pl common -am generate-sources
