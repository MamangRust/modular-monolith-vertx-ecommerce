...
public class AuthHandler implements pb.VertxAuthServiceGrpcServer.AuthServiceApi {
        ...
        public Future<ApiResponseResetPassword> resetPassword(ResetPasswordRequest request) {
                io.example.auth.domain.requests.ResetPasswordRequest domainReq = io.example.auth.domain.requests.ResetPasswordRequest
                                .builder()
        ...
        public Future<ApiResponseRegister> registerUser(RegisterRequest request) {
                io.example.auth.domain.requests.RegisterRequest domainReq = io.example.auth.domain.requests.RegisterRequest
                                .builder()
        ...
        public Future<ApiResponseLogin> loginUser(LoginRequest request) {
                io.example.auth.domain.requests.AuthRequest domainReq = io.example.auth.domain.requests.AuthRequest
                                .builder()
                                .email(request.getEmail())
                                .password(request.getPassword())
                                .build();
