...
public class PasswordResetService {
    ...
    public Future<Boolean> resetPassword(ResetPasswordRequest request) {
        ...
        return redisService.get("resetToken:" + request.getResetToken())
                ...
                .compose(userId -> {
                    UpdateUserPasswordRequest updatePasswordReq = UpdateUserPasswordRequest.builder()
                            .userId(userId)
                            .password(request.getPassword())
                            .build();

                    return userRepository.updateUserPassword(updatePasswordReq)
                            .compose(u -> {
    ...
    public Future<Boolean> verifyCode(String code) {
        ...
        return userRepository.findByVerificationCode(code)
                .compose(user -> {
                    ...
                    UpdateUserVerifiedRequest updateVerifiedReq = UpdateUserVerifiedRequest.builder()
                            .userId(user.getUserId())
                            .isVerified(true)
                            .build();

                    return userRepository.updateUserIsVerified(updateVerifiedReq)
