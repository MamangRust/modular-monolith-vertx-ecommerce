...
public class BannerQueryRepositoryImpl implements BannerQueryRepository {
    ...
    public BannerQueryRepositoryImpl(Pool client) {
        this.client = client;
    }

    @Override
    public Future<PagedResult<Banner>> getBanners(String search, int page, int pageSize) {
    ...
    @Override
    public Future<PagedResult<Banner>> getActiveBanners(String search, int page, int pageSize) {
        int offset = (page > 0 ? page - 1 : 0) * pageSize;
    ...
    @Override
    public Future<PagedResult<Banner>> getTrashedBanners(String search, int page, int pageSize) {
        int offset = (page > 0 ? page - 1 : 0) * pageSize;
