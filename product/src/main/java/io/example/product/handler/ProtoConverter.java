...
public class ProtoConverter {
    ...
    public static pb.product.ProductCommon.ProductResponse fromProductResponse(ProductResponse r) {
        if (r == null) {
            return pb.product.ProductCommon.ProductResponse.getDefaultInstance();
        }
        return pb.product.ProductCommon.ProductResponse.newBuilder()
    ...
    public static pb.product.ProductCommon.ProductResponseDeleteAt fromProductResponseToDeleteAt(ProductResponse r) {
        if (r == null) {
            return pb.product.ProductCommon.ProductResponseDeleteAt.getDefaultInstance();
        }
        return pb.product.ProductCommon.ProductResponseDeleteAt.newBuilder()
                .setId(r.getId() != null ? r.getId().intValue() : 0)
                .setMerchantId(r.getMerchantId() != null ? r.getMerchantId() : 0)
                .setCategoryId(r.getCategoryId() != null ? r.getCategoryId() : 0)
                .setName(r.getName() != null ? r.getName() : "")
    ...
    public static pb.product.ProductCommon.ProductResponseDeleteAt fromProductResponseDeleteAt(ProductResponseDeleteAt r) {
        if (r == null) {
            return pb.product.ProductCommon.ProductResponseDeleteAt.getDefaultInstance();
        }
        pb.product.ProductCommon.ProductResponseDeleteAt.Builder b = pb.product.ProductCommon.ProductResponseDeleteAt.newBuilder()
                .setId(r.getId() != null ? r.getId().intValue() : 0)
                .setMerchantId(r.getMerchantId() != null ? r.getMerchantId() : 0)
                .setCategoryId(r.getCategoryId() != null ? r.getCategoryId() : 0)
                .setName(r.getName() != null ? r.getName() : "")
