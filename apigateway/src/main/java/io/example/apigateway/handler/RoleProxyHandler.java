...
import pb.VertxRoleCommandServiceGrpcClient;
import pb.VertxRoleQueryServiceGrpcClient;

public class RoleProxyHandler {
  private final VertxRoleQueryServiceGrpcClient queryClient;
  private final VertxRoleCommandServiceGrpcClient commandClient;

  public RoleProxyHandler(VertxRoleQueryServiceGrpcClient queryClient, VertxRoleCommandServiceGrpcClient commandClient) {
    this.queryClient = queryClient;
    this.commandClient = commandClient;
  }

  public void findAll(RoutingContext ctx) {
    var req = RoleQuery.FindAllRoleRequest.newBuilder()
  ...
  public void findById(RoutingContext ctx) {
    ...
    var req = RoleCommon.FindByIdRoleRequest.newBuilder().setRoleId(id).build();
