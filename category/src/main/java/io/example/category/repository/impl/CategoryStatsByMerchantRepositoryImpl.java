...
public class CategoryStatsByMerchantRepositoryImpl implements CategoryStatsByMerchantRepository {
    ...
    @Override
    public Future<List<CategoriesMonthlyTotalPrice>> getMonthlyTotalPriceByMerchant(CategoryCommon.FindYearMonthTotalPriceByMerchant req) {
    ...
    @Override
    public Future<List<CategoriesYearlyTotalPrice>> getYearlyTotalPriceByMerchant(CategoryCommon.FindYearTotalPriceByMerchant req) {
        return client
                .preparedQuery("""
                        WITH yearly_data AS (
    ...
    @Override
    public Future<List<CategoriesMonthPrice>> getMonthlyCategoryByMerchant(CategoryCommon.FindYearCategoryByMerchant req) {
    ...
    @Override
    public Future<List<CategoriesYearPrice>> getYearlyCategoryByMerchant(CategoryCommon.FindYearCategoryByMerchant req) {
        Timestamp refTs = Timestamp.valueOf(LocalDateTime.of(req.getYear(), 1, 1, 0, 0));
        return client
                .preparedQuery("""
