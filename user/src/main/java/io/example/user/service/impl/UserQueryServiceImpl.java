...
public class UserQueryServiceImpl implements UserQueryService {
  ...
  public Future<PagedResult<UserResponse>> getUsers(FindAllUsers req) {
    ...
    return redis.get(cacheKey)
        .compose(jsonStr -> {
          ...
          return repository.getUsers(FindAllUsers.builder()
  ...
  public Future<PagedResult<UserResponseDeleteAt>> getActiveUsers(FindAllUsers req) {
    ...
    return redis.get(cacheKey)
        .compose(jsonStr -> {
          ...
          return repository.getActiveUsers(FindAllUsers.builder()
              .search(req.getSearch())
              .page(req.getPage())
              .pageSize(req.getPageSize())
              .build())
  ...
  public Future<PagedResult<UserResponseDeleteAt>> getTrashedUsers(FindAllUsers req) {
    ...
    return redis.get(cacheKey)
        .compose(jsonStr -> {
          ...
          return repository.getTrashedUsers(FindAllUsers.builder()
              .search(req.getSearch())
              .page(req.getPage())
              .pageSize(req.getPageSize())
              .build())
  ...
  @Override
  public Future<UserResponse> getUserById(Long id) {
