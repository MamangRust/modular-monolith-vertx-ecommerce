        ...
        .compose(cached -> {
          if (cached != null) {
            ...
            return Future.succeededFuture(
                new ApiResponsePagination<>("success", "Users fetched successfully (from cache)", data, meta));
          }
    ...
    return redis.get(cacheKey)
        .compose(cached -> {
          if (cached != null) {
            ...
            return Future.succeededFuture(
                new ApiResponsePagination<>("success", "Active users fetched successfully (from cache)", data, meta));
          }
    ...
    return redis.get(cacheKey)
        .compose(cached -> {
          if (cached != null) {
            ...
            return Future.succeededFuture(
                new ApiResponsePagination<>("success", "Trashed users fetched successfully (from cache)", data, meta));
          }
