...
public class UserCommandRepositoryImpl implements UserCommandRepository {
  ...
  public Future<User> updateUser(UpdateUserRequest request) {
    return client
        ...
        .execute(Tuple.of(request.getFirstName() != null ? request.getFirstName() : "", request.getLastName() != null ? request.getLastName() : "", request.getEmail() != null ? request.getEmail() : "", request.getUserId()))
        .map(this::mapSingleOrNull);
  }

  @Override
  public Future<User> updatePassword(UpdateUserPasswordRequest request) {
    return client
        .preparedQuery(
  ...
  @Override
  public Future<User> restore(Long userId) {
    return client
        .preparedQuery(
  ...
  @Override
  public Future<User> trashed(Long userId) {
    return client
        .preparedQuery(
  ...
  public Future<Boolean> deletePermanent(Long userId) {
    return client
