...
public class ProtoConverter {
    ...
    public static pb.order_item.OrderItemCommon.OrderItemResponse toProto(OrderItem o) {
        if (o == null) return pb.order_item.OrderItemCommon.OrderItemResponse.getDefaultInstance();
    ...
    public static pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt toProtoDeleteAt(OrderItem o) {
        if (o == null) return pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt.getDefaultInstance();
        pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt.Builder b = pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt.newBuilder()
                .setId(o.getOrderItemId() != null ? o.getOrderItemId().intValue() : 0)
                .setOrderId(o.getOrderId() != null ? o.getOrderId() : 0)
                .setProductId(o.getProductId() != null ? o.getProductId() : 0)
                .setQuantity(o.getQuantity() != null ? o.getQuantity() : 0)
    ...
    public static pb.order_item.OrderItemCommon.OrderItemResponse fromModel(OrderItemResponse r) {
        if (r == null) return pb.order_item.OrderItemCommon.OrderItemResponse.getDefaultInstance();
        return pb.order_item.OrderItemCommon.OrderItemResponse.newBuilder()
    ...
    public static pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt fromModelDeleteAt(OrderItemResponseDeleteAt r) {
        if (r == null) return pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt.getDefaultInstance();
        pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt.Builder b = pb.order_item.OrderItemCommon.OrderItemResponseDeleteAt.newBuilder()
                .setId(r.getId() != null ? r.getId().intValue() : 0)
                .setOrderId(r.getOrderId() != null ? r.getOrderId() : 0)
                .setProductId(r.getProductId() != null ? r.getProductId() : 0)
    ...
    public static pb.order_item.OrderItemCommon.OrderItemResponse fromModelDeleteAtToResponse(OrderItemResponseDeleteAt r) {
        if (r == null) return pb.order_item.OrderItemCommon.OrderItemResponse.getDefaultInstance();
        return pb.order_item.OrderItemCommon.OrderItemResponse.newBuilder()
                .setId(r.getId() != null ? r.getId().intValue() : 0)
                .setOrderId(r.getOrderId() != null ? r.getOrderId() : 0)
